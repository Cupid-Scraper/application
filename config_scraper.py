...
# LOCATIONS where you'd like to find a match (location spelling needs to match
# the spelling on OkCupid)
locations = [
...
# Absolutely Not - Matches that have these words in their profile will
...
music = [
    ...
    'bach', 'tom petty', 'heartbreakers', 'incredible bongo band',
